...
module.exports = function (modules, dirname, clone) {
    ...
    for (var _i = 0, _a = modules.moduleList; _i < _a.length; _i++) {
        ...
        if (module_1.startsWith("gh://")) {
            ...
            url = "https://" + f[2] + "@bitbucket.org/" + module_1.replace("bb://", "");
        }
            ...
            fs.rmdirSync(dirname + "/modules/" + module_1.replace("@", "").replace("npm://", ""), { recursive: true });
            ncp(dirname + "/node_modules/" + module_1.replace("npm://", ""), dirname + "/modules/" + module_1.replace("@", "").replace("npm://", ""), function (err) {
                if (err) {
